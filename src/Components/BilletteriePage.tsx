...
import { Check, Ticket, Star, Sparkles } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        >
          ...
          <p className="text-xl text-[#b8a99a] max-w-3xl mx-auto">
            Sélectionne le pass qui te correspond pour vivre une immersion totale dans les
              ...
              <div className={`p-8 ${pass.badge ? 'pt-14' : ''}`}>
                ...
                <div className="mb-8 space-y-3">
                  <div className="flex items-baseline gap-2">
                    <span className="text-4xl text-[#d4a574]">{pass.prices.plein}€</span>
                    <span className="text-[#b8a99a]">Plein tarif</span>
                  </div>
                  <div className="text-[#b8a99a] space-y-1">
                    <div>Tarif réduit : <span className="text-[#e8d5b7]">{pass.prices.reduit}€</span></div>
                    <div>Kids (6-12 ans) : <span className="text-[#e8d5b7]">{pass.prices.kids}€</span></div>
        ...
        >
          <h3 className="text-2xl mb-6 text-[#f5f1ea]">Informations importantes</h3>
          
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h4 className="text-lg mb-4 text-[#d4a574]">Tarifs spécifiques</h4>
              <ul className="space-y-2 text-[#b8a99a]">
                ...
                <li className="flex items-start gap-3">
                  <Check className="w-5 h-5 text-[#d4a574] flex-shrink-0 mt-0.5" />
                  <span>Demandeurs d'emploi : tarif réduit avec justificatif</span>
                </li>
              </ul>
            </div>

            <div>
              <h4 className="text-lg mb-4 text-[#d4a574]">Conditions générales</h4>
              <ul className="space-y-2 text-[#b8a99a]">
                <li className="flex items-start gap-3">
                  <Check className="w-5 h-5 text-[#d4a574] flex-shrink-0 mt-0.5" />
                ...
                <li className="flex items-start gap-3">
                  <Check className="w-5 h-5 text-[#d4a574] flex-shrink-0 mt-0.5" />
                  <span>Billets non remboursables (sauf annulation du festival)</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-8 p-6 bg-[#d4a574]/10 border border-[#d4a574]/30 rounded-xl">
            <p className="text-[#e8d5b7] text-center">
              <span className="text-[#d4a574]">💡 Conseil :</span> Les billets sont en quantité limitée.
              Réserve ton pass dès maintenant pour garantir ta place à Souk Sonore 2025 !
            </p>
          </div>
        </motion.div>
      </div>
