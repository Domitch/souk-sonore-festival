...
import { ArrowRight, Music, Users, Heart } from 'lucide-react';
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          ...
          >
            ...
            >
              Plongez dans un festival unique où les rythmes africains, latinos et arabes se
              rencontrent pour célébrer la diversité, le partage et la magie de la musique.
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-[#b8a99a] max-w-3xl mx-auto">
              Souk Sonore est bien plus qu'un festival : c'est une célébration du métissage
              culturel, un espace de rencontre et d'échange entre les peuples et les traditions.
            </p>
          </motion.div>
            ...
            {[
              {
                icon: Music,
                title: 'Diversité',
                description: 'Une programmation riche qui célèbre la diversité musicale des cultures africaine, latino et arabe.',
              },
              {
                icon: Users,
                title: 'Partage',
                description: 'Un lieu de rencontre et d\'échange où les cultures se mêlent dans une atmosphère conviviale.',
              },
              {
                icon: Heart,
                title: 'Célébration',
                description: 'Une expérience immersive qui honore les traditions tout en embrassant la modernité.',
              },
            ].map((value, index) => (
              <motion.div
                key={value.title}
              ...
              >
                ...
                <p className="text-[#b8a99a] leading-relaxed">{value.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
